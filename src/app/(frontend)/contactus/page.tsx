        ...
        <Container size="xl">
            <Box className={style.secondabout}>
                ...
                <Text fw="600" className={style.text1}>
                    {conItems?.contactText}<span className={style.aboutcom}> {conItems?.contactTexthighlight}</span>
                </Text>
                <Text className={style.text2}>
                   {conItems?.contactusparagraphtext}
                </Text>
                <Text className={style.text2}>
                   <span className={style.aboutcom}>{conItems?.contactph}</span> {conItems?.contactdetails} <span className={style.aboutcom}>{conItems?.email}</span>{conItems?.emaildetails}
                </Text>
                </Box>
